<template>
  <div class="mg-hm-ovl" role="dialog" aria-modal="true">
    <div class="mg-hm-panel">
      ...
      <button class="hm-close" @click="handleClose" :aria-label="t('home.sensitiveContentUnderage.ok')">
      ...
      <p class="hm-body">{{ t('home.sensitiveContentUnderage.description') }}</p>

      <div class="hm-actions">
        <button class="mg-hm-btn primary" @click="handleClose">{{ t('home.sensitiveContentUnderage.ok') }}</button>
      </div>
    </div>
  </div>
</template>
...
.hm-badge {
  ...
  background: $yellow; color: #1a1a1a; border: 1px solid #3d3d3d;
...
.mg-hm-btn {
  flex: 1; padding: 11px 10px; border-radius: 18px; border: 1px solid #3d3d3d;
